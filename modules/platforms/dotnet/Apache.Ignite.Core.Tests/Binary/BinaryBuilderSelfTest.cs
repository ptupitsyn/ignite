...
namespace Apache.Ignite.Core.Tests.Binary
{
    ...
    public class BinaryBuilderSelfTest
    {
        ...
        public void TestTypeId()
        {
            ...
            Assert.AreEqual(JavaHashCode.GetBinaryBasicIdMapperLowerCaseHashCode("someTypeName"), _grid.GetBinary().GetTypeId("someTypeName"));
        }
        ...
        public void TestTypeName()
        {
            ...
            Assert.AreEqual(JavaHashCode.GetBinaryBasicIdMapperLowerCaseHashCode(NameMapper.TestTypeName + "_"), binType.TypeId);
