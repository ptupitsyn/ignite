...
namespace Apache.Ignite.Core.Impl.DataStructures
{
    ...
    /// <summary>
    /// Enumerator communicating with Java.
    /// </summary>
    internal class IgniteEnumerator<T> : PlatformDisposableTarget, IEnumerator<T>
    {
        ...
        public IgniteEnumerator(IUnmanagedTarget target, Marshaller marsh, bool keepBinary) : 
            base(target, marsh)
        {
