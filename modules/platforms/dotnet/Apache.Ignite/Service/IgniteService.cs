...
namespace Apache.Ignite.Service
{
    ...
    /// </summary>
    internal class IgniteService : ServiceBase, ILifecycleEventHandler
    {
        /** Service name. */
        ...
        public IgniteService(IgniteConfiguration cfg)
        {
            ...
            var handlers = _cfg.LifecycleEventHandlers ?? new List<ILifecycleEventHandler>();

            handlers.Add(this);

            _cfg.LifecycleEventHandlers = handlers;
        }
